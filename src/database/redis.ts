...
interface RedisModule {
    ...
    client: any;
    init(): Promise<void>;
    createSessionStore(options: any): Promise<session.SessionStore>;
    checkCompatibility(): Promise<void>;
    checkCompatibilityVersion(version: any, callback?: any): void;
    close(): Promise<void>;
    info(cxn?: any): Promise<any>;
    socketAdapter(): Promise<any>;
} // Code for the interface is generated by ChatGPT and then modified

const redisModule = {} as RedisModule;
...
redisModule.info = async function (cxn) {
    ...
    interface RedisData {
        ...
        avg_ttl: string;
        redis: boolean;
        instantaneous_input: string;
        instantaneous_output: string;
        instantaneous_input_kbps: number;
        instantaneous_output_kbps: number;
        total_net_input: string;
        total_net_output: string;
